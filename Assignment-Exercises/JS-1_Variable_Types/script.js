...
// Using let
let name = "Juan Dela Cruz"; // Define a string here, e.g., "Juan Cruz"
let age = 18; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["reading", "journaling", "coding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["2006", "Brave New World", "Farenheit 451"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
